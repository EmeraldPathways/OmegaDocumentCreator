...
class FactFind(Base):
    ...
    smoker_status: Mapped[str | None] = mapped_column(Text, nullable=True)
    phi_occupational_class: Mapped[str | None] = mapped_column(Text, nullable=True)
    phi_indexation: Mapped[str | None] = mapped_column(Text, nullable=True)
