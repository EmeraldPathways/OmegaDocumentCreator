...
const WORKFLOW_BLOCK_CLASSES = new Set([
  ...
  "fact-find-comments-box",
  "fact-find-life-insurance-card",
  "fact-find-life-insurance-summary-row",
  "fact-find-life-insurance-divider",
  "fact-find-life-insurance-block",
  "fact-find-life-insurance-policy-list",
  "fact-find-life-insurance-policy-row",
  "fact-find-pension-card",
  "fact-find-pension-header",
  "fact-find-pension-panel",
  "fact-find-pension-panel-header",
  "fact-find-pension-detail-list",
  "fact-find-pension-metric-row",
  "fact-find-pension-contributions-row",
  "fact-find-pension-contributions-values",
  "fact-find-pension-contribution-block",
  "fact-find-pension-empty-state",
]);
...
const WORKFLOW_TEXT_CLASSES = new Set([
  ...
  "fact-find-comments-label",
  "fact-find-comments-value",
  "fact-find-life-insurance-summary-label",
  "fact-find-life-insurance-policy-label",
  "fact-find-life-insurance-value",
  "fact-find-pension-heading",
  "fact-find-pension-chip",
  "fact-find-pension-status",
  "fact-find-pension-panel-status",
  "fact-find-pension-metric-label",
  "fact-find-pension-value",
  "fact-find-pension-contribution-label",
  "fact-find-pension-empty-title",
  "fact-find-pension-empty-copy",
]);
...
const WorkflowBlockNode = Node.create({
  ...
  parseHTML() {
    return [
      ...
      { tag: "div.fact-find-comments-box" },
      { tag: "div.fact-find-life-insurance-card" },
      { tag: "div.fact-find-life-insurance-summary-row" },
      { tag: "div.fact-find-life-insurance-divider" },
      { tag: "div.fact-find-life-insurance-block" },
      { tag: "div.fact-find-life-insurance-policy-list" },
      { tag: "div.fact-find-life-insurance-policy-row" },
      { tag: "div.fact-find-pension-card" },
      { tag: "div.fact-find-pension-header" },
      { tag: "div.fact-find-pension-panel" },
      { tag: "div.fact-find-pension-panel-header" },
      { tag: "div.fact-find-pension-detail-list" },
      { tag: "div.fact-find-pension-metric-row" },
      { tag: "div.fact-find-pension-contributions-row" },
      { tag: "div.fact-find-pension-contributions-values" },
      { tag: "div.fact-find-pension-contribution-block" },
      { tag: "div.fact-find-pension-empty-state" },
